...
---
I explain deeper [how is structured an action and how to use docker services in an article](https://dev.to/s_abderemane/how-to-create-github-actions-to-run-tests-with-services-2653)  but I will focus here more on services. 
